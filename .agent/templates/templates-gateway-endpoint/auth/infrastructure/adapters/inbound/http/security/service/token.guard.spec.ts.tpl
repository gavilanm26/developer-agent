...
describe('TokenGuard', () => {
  ...
  let msIdentityAuth: MsIdentityAuthRestClient;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: MsIdentityAuthRestClient,
          useValue: {
            validate: jest.fn(),
          },
        },
    ...
    msIdentityAuth = module.get<MsIdentityAuthRestClient>(MsIdentityAuthRestClient);
  });
